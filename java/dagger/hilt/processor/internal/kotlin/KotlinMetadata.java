...
abstract class KotlinMetadata {
  ...
  Optional<XExecutableElement> getSyntheticAnnotationMethod(XFieldElement fieldElement) {
  ...
  FunctionMetadata getFunctionMetadata(XExecutableElement method) {
  ...
  abstract static class MethodForAnnotations {
    static MethodForAnnotations create(XExecutableElement method) {
